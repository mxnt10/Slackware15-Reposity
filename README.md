...
| `CPU-X`                    | `4.3.1`          | `i586` `x86_64` `arm`   |                         |
| `flareget`                 | `5.0.0`          | `i586` `x86_64`         |                         |
| `freeoffice2021`           | `1036`           | `x86_64`                |                         |
| `google-chrome`            | `102.0.5005.61`  | `x86_64`                |                         |
| `google-earth`             | `7.3.4.8642`     | `x86_64`                |                         |
| `mpv`                      | `0.34.1`         | `i586` `x86_64` `arm`   | `hypnotix`              |
| `mx-conky`                 | `21.7`           | `i586` `x86_64` `arm`   |                         |
| `nulloy`                   | `0.8.2_112`      | `i586` `x86_64` `arm`   |                         |
| `ocenaudio`                | `3.11.12`        | `i586` `x86_64`         |                         |
| `p7zip`                    | `17.04`          | `i586` `x86_64` `arm`   | `acetoneiso`            |
| `photoqt`                  | `2.6`            | `i586` `x86_64` `arm`   |                         |
| `qbittorrent`              | `4.4.3.1`        | `i586` `x86_64` `arm`   |                         |
| `QMPlay2`                  | `22.03.19`       | `i586` `x86_64` `arm`   |                         |
| `spotify`                  | `1.1.84.716`     | `x86_64`                |                         |
| `telegram`                 | `3.7.5`          | `x86_64`                |                         |
...
| `graphicsmagick`           | `1.3.38`         | `i586` `x86_64` `arm`   | `photoqt`               |
| `imlib2`                   | `1.9.0`          | `i586` `x86_64` `arm`   | `conky`                 |
| `jack`                     | `1.9.21`         | `i586` `x86_64` `arm`   | `ocenaudio` `portaudio` |
| `libass`                   | `0.16.0`         | `i586` `x86_64` `arm`   | `mpv` `QMPlay2`         |
...
| `libtorrent-rasterbar`     | `1.2.14`         | `i586` `x86_64` `arm`   | `qbittorrent`           |
| `lua`                      | `5.1.5`          | `i586` `x86_64` `arm`   | `mpv` `tolua++`         |
| `mujs`                     | `1.2.0`          | `i586` `x86_64` `arm`   | `mpv`                   |
| `portaudio`                | `19.7.0`         | `i586` `x86_64` `arm`   | `QMPlay2`               |
| `pugixml`                  | `1.12.1`         | `i586` `x86_64` `arm`   | `photoqt`               |
| `rar`                      | `6.12`           | `x86_64`                | `acetoneiso`            |
| `tolua++`                  | `1.0.93`         | `i586` `x86_64` `arm`   | `conky`                 |
| `wxGTK3`                   | `3.0.5.1`        | `i586` `x86_64` `arm`   | `codeblocks` `p7zip`    |
| `xa`                       | `2.3.13`         | `i586` `x86_64` `arm`   | `libsidplayfp`          |
| `........................` | `..............` | `.....................` | `.....................` |
...
| `gst-plugins-bad`          | `1.18.5`         | `i586` `x86_64` `arm`   | `nulloy` `transmageddon`  |
| `gst-plugins-ugly`         | `1.18.5`         | `i586` `x86_64` `arm`   | `nulloy` `transmageddon`  |
...
| `zenity`                   | `3.32.0`         | `i586` `x86_64` `arm`   | `cpu-limit`             |
| `........................` | `..............` | `.....................` | `.....................` |
